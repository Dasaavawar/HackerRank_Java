/* HackerRank - Java - Challenges - VI - Exception Handling - Java 8 */


/* 1. Exception Handling - Java Exception Handling */
/*
You are required to compute the power of a number by implementing a calculator. Create a class MyCalculator which consists of a single method long power(int, int). This method takes two integers, n and p, as parameters and finds n^p. If either or is negative, then the method must throw an exception which says "n or p should not be negative.". Also, if both n and p are zero, then the method must throw an exception which says "n and p should not be zero.".
...
/* 2. Exception Handling - Java Exception Handling (Try-catch) */
/*
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (e.getClass() == ArithmeticException.class) {
                System.out.println(e);
            } else if (e.getClass() == InputMismatchException.class) {
